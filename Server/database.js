...
module.exports = { connectToDatabase, login, getAllBooks, getAllReceipts, order, addBook, addUser, checkUsernameExists, changePassword, updateReceiptStatus,updateReceipt };
